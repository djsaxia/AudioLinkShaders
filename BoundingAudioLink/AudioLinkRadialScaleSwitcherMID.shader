Shader "Custom/AudioLinkRadialScaleSwitcherMID"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                float audio = AudioLinkData(ALPASS_AUDIOLINK + ALPASS_AUDIOLOWMIDS).r;
                float audio2 = AudioLinkData(ALPASS_AUDIOLINK + ALPASS_AUDIOHIGHMIDS).r;
                ...
                if (hasAudio)
                {
                    ...
                    // fadeT = amp;
                    float targetAmp = pow(smoothstep(0.05, 0.4, (audio + audio2)), 0.5);
